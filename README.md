...
> 0.1.8 — локальный SOCKS5 можно подставить в Telegram одной кнопкой: приложение открывает официальный экран добавления с уже заполненными сервером и портом. Подписанный APK публикуется в Releases после автоматических проверок. Работа обхода на конкретном телефоне и у конкретного провайдера требует проверки.
