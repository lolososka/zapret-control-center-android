...
> 0.1.5 — понятные профили для мессенджеров и игрового трафика, более мягкая UDP-совместимость и краткая диагностика по умолчанию. Подписанный APK публикуется в Releases после автоматических проверок. Работа обхода на конкретном телефоне и у конкретного провайдера требует проверки.
