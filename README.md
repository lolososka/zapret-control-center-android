...
> 0.1.7 — на главном экране появился помощник локального SOCKS5 для Telegram: копирование адреса, проверка порта и быстрый запуск приложения. Подписанный APK публикуется в Releases после автоматических проверок. Работа обхода на конкретном телефоне и у конкретного провайдера требует проверки.
