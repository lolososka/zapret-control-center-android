...
> 0.1.4 — иконка в точности как у ПК-версии и более плавная панель соединения. Подписанный APK публикуется в Releases после автоматических проверок. Работа обхода на конкретном телефоне и у конкретного провайдера требует проверки.
