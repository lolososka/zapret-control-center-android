...
object StrategyProfiles {
    ...
    enum class Profile(
        ...
        private val splitAtHost: Boolean,
        private val tlsRecordSplit: Boolean,
        private val tlsRecordSplitAtSni: Boolean,
        private val fakeTtl: Int,
        private val fakeOffset: Int,
    ) {
        Auto(
            "auto",
